...
public class SearchNum extends HttpServlet {
	...
	public void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		try {
			stmt = conn.prepareStatement("select count(*) as count  from goods where goodsID=?");
			stmt.setInt(1, id);
			...
			if(count>0){
				...
				SkuToSpu skuToSpu = new SkuToSpu(id);
				goodsID = skuToSpu.getSpu();
			}
